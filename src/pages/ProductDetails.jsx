...
import { RiArrowLeftLine, RiShoppingBagLine, RiHeartLine, RiStarFill } from 'react-icons/ri'
        ...
        <div className="grid md:grid-cols-2 gap-16">
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }}>
            ...
            <div className="flex gap-3 mb-8">
              ...
              <button className="w-14 h-14 border border-taupe flex items-center justify-center hover:border-dark transition-colors">
